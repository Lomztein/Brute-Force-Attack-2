...
{
    // Could probably refactor this to share a common base class with OnlyCertainStructureRequirement, but the shared parts aren't really something I'd consider worth the refactor.
    public class OnlyCertainAssemblyComponentsOnFieldRequirement : AchievementRequirement
    {
        ...
        private bool CheckField()
        {
            if (StructureManager.Instance != null)
            {
                ...
                {
                    if (structuresItem is TurretAssembly assembly)
                    {
        ...
        private bool CheckComponent(Structure structure)
        {
        ...
        private void Structures_OnStructureHierarchyChanged(Structure arg1, GameObject arg2, object arg3)
        {
            CheckRequirements();
        }

        private void Structures_OnStructureAdded(Structure obj, object source)
        {
            CheckRequirements();
        }
    }
